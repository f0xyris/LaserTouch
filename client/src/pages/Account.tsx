...
import { Calendar, Clock, MapPin, Phone, Mail, Star, Edit2, LogIn, User, Camera, Upload } from "lucide-react";
          ...
          <Card className="lg:col-span-1">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <Calendar className="h-4 w-4 text-mystical-500" />
                  <span className="text-sm text-mystical-600 dark:text-mystical-400">
                    {t.accountTitle || "Client since"}:
                  </span>
                  <span className="text-sm font-medium text-mystical-700 dark:text-mystical-300">
                  ...
                  <div className="space-y-4">
                    {(appointments as any[]).map((appointment: any) => (
                      ...
                      >
                        <div className="flex justify-between items-start mb-2">
                          <div>
                            <h4 className="font-semibold text-mystical-600 dark:text-mystical-400">
                              {typeof appointment.service?.name === 'object' ? 
                                (appointment.service.name.ua || appointment.service.name.en || appointment.service.name.pl || appointment.service.name.ru || "Service") : 
